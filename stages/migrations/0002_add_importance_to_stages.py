...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Stage.importance'
        db.add_column('stages_stage', 'importance', orm['stages.stage:importance'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Stage.importance'
        db.delete_column('stages_stage', 'importance')
