...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding ManyToManyField 'Stage.softlinks'
        db.create_table('stages_stage_softlinks', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_stage', models.ForeignKey(orm.Stage, null=False)),
            ('to_stage', models.ForeignKey(orm.Stage, null=False))
        ))
    ...
    def backwards(self, orm):
        ...
        # Dropping ManyToManyField 'Stage.softlinks'
