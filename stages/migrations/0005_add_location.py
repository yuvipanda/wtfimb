...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Stage.location'
        db.add_column('stages_stage', 'location', orm['stages.stage:location'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Stage.location'
        db.delete_column('stages_stage', 'location')
